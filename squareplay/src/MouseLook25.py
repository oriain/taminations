...
def main():
  ...
  # use mouse look
  lr = useMouseLook(controller, capped, move, invert, sensitivity)
  if 'PythonObject' in obj:
    #  Hack for now to save rotation for processing snap
    obj['PythonObject'].didRotate(lr)
