...
Call.classes['allemandeleft'] = defineClass({
  name: "Allemande Left",
  extend: Call,
  methods: {
    performOne: function(ctx,d) {
      ...
      if (d2 != undefined && ctx.dancerInFront(d2) == d) {
        ...
        var moves = tam.translatePath([{ select: 'Extend Right', scaleX: dist/2, scaleY: 0.5 },
...
Call.classes['leftturnthru'] = defineClass({
  name: "Left Turn Thru",
  extend: Call.classes['allemandeleft']
});
