...
define(function() {
  ...
  Math.repArray = function(s,v,k) {
    ...
    for (var i=n-1; i>=0; i--)
      ret[i] = Math.repArray(s,v,k+1);
    return ret;
  }

  
  Math.epsilon = 2.220446049250313e-16;
  Math.svd= function svd(A) {
    var temp;
//Compute the thin SVD from G. H. Golub and C. Reinsch, Numer. Math. 14, 403-420 (1970)
  var prec= Math.epsilon; //Math.pow(2,-52) // assumes double prec
